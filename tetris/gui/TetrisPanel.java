...
public class TetrisPanel extends JPanel {
    ...
    private int mySquareWidth, myBasketWidth, myBasketHeight,
            mySmallDimension;
    ...
    public void paintComponent(Graphics g) {
        ...
        mySquareWidth =
                Math.min((int)((getWidth() - (myGame.getBasketGrid()
                        .getNumCols()
                        ...
                        * GAP) / (myGame.getBasketGrid().getNumCols()
                        ...
                        (getHeight() - (myGame.getBasketGrid()
                                .getNumRows() - 1) * GAP)
                                / (myGame.getBasketGrid().getNumRows()));
        myBasketWidth =
                myGame.getBasketGrid().getNumCols()
        ...
        g.translate((getWidth() - (myBasketWidth + 5 * mySquareWidth
                / 2 + 2 * mySmallDimension)) / 2,
                (getHeight() - myBasketHeight) / 2);
        ...
        g.drawRect(mySmallDimension + myBasketWidth + 5 * mySquareWidth
                / 2, 0, mySmallDimension - 1, mySmallDimension - 1);
        ...
        for (int col = 0; col < myGame.getNextGrid().getNumCols(); ++col)
            for (int row = 0; row < myGame.getNextGrid().getNumRows(); ++row)
                ...
                paintSquare(g, myGame.getNextGrid().get(col, row),
                        mySmallDimension + myBasketWidth + 5
                                * mySquareWidth / 2 + col
                                * (mySquareWidth + GAP) + GAP, (myGame
                                .getNextGrid().getNumRows() - row - 1)
                                * (mySquareWidth + GAP) + GAP);
        ...
        if (myGame.getState() != GameState.ON) {
            ...
            g.drawString(myGame.getState() == GameState.PAUSED
                    ? "Paused" : "Game Over", 0,
                    9 * (mySquareWidth + GAP) / 2);
        }
    }
